...
//		// Date date = new Date("2014-12-12 22:38:45");
//		// System.out.println(DateUtil.getDay("2014-12-13 22:38:45"));
//		System.out.println(DateUtil
//				.getInteger(new Date(), Calendar.DAY_OF_WEEK));
//		Date d = DateUtil.addDay(new Date(), -2);
//		System.out.println(d);
//		System.out.println(DateUtil.addDay(new Date(), 5));
//		int a = DateUtil.calculateIntervalDays(d, new Date());
